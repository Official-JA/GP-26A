...
namespace AA0000
{
	public class BaseObjectCreator : MonoBehaviour
	{
		...
		public bool useSpawnLocationController = true;
		...
		void Start()
		{
			//if (prefabContainingBaseObject == null) //<- this
			//{
			//	Debug.Log("We want that, because it was not defined");
			//}
			//if (prefabContainingBaseObject.name == nonPrefabBaseObject.name) //<- or this
			//{
			//	Debug.Log("We want this, because we can check if the properties match ");
			//}
			//if (prefabContainingBaseObject == nonPrefabBaseObject) //<- not this
			//{
			//	Debug.Log("We do not want this");
			//}

			if (useSpawnLocationController)
			{
